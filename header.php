...
<style type="text/css">
<?php 
$this_alt_header = get_option('x21_alt_header');
 if (!$this_alt_header) : ?>
#header {background:url(<?php echo get_template_directory_uri(); ?>/images/header-def.jpg) no-repeat 0 0;}
<?php else : ?>
#header {background:url(<?php echo get_template_directory_uri(); ?>/images/header-alternate.jpg) no-repeat 0 0;}
<?php endif; ?>
<?php
...
<div id="topnav">
<ul>
<li id="first-item"<?php if(is_home()) { ?> class="current_page_item"<?php } ?>><a href="<?php echo home_url(); ?>">Home</a></li>
